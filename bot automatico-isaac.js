...
const roomName = "[🏆] HOST AUTOMATICO | x2 x3 x4 x5 x7 🎉";
const botName = "botpro";
const maxPlayers = 30;
const roomPublic = false;
const geo = [{"code": "pe", "lat": -34.6, "lon": -58.4}]; // Geo

const room = HBInit({ roomName: roomName, maxPlayers: maxPlayers, public: roomPublic, playerName: botName, geo: geo[0] });

const adminPassword = "mideidad";

const vipPassword = "midvip";
...
function PublicitaDiscord(player) {
    ...
    room.sendAnnouncement("                                         room to be given stat information every X minutes
var endGameVariable = false; // This variable with the one below helps distinguish the cases where games are stopped because they have finished to the ones where games are stopped due to player movements or resetting teams
var resettingTeams = false;
var capLeft = false;
var statInterval = 6;
...
room.onPlayerJoin = function (player) {
    ...
    room.sendAnnouncement("👋 ¡𝗕𝗶𝗲𝗻𝘃𝗲𝗻𝗶𝗱𝗼 " + player.name + " a CaraBobo host", null, 0xFFC37,"bold");
